...
/**
 * Class implements the TeaTime protocol, using timeout-base two phase commit protocol to provide synchonisation
 * 
 * @author sage
 */
public class TObject {
   ...
   * 
   * @throws Error if the atomic operation to which q is the Possibility has been commited bevore all Write Operations
   * (like this one) have been completed
   */
